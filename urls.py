...
urlpatterns = patterns('',
    ...
    url(r'^band/(?P<band_id>\d+)/events/gigs/add$', 'project.views_band.add_gig', name='add-gig'),
    url(r'^band/(?P<band_id>\d+)/events/gigs/(?P<entry_id>\d+)/remove$', 'project.views_band.remove_gig', name='remove-gig'),
